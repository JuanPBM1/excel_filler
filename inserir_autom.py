...
indice_inicial = input("Insira o número da linha do excel em que os dados devem começar a ser inseridos\n\n") # a linha do arquivo excel que deverá ser inserida
num_colunas = input("Insira o número de colunas que deverão ser inseridas no arquivo excel") # o número de colunas que deverão ser inseridas no arquivo excel
num_linhas = input("Insira o número de linhas que deverão ser inseridas no arquivo excel") # o número de linhas que deverão ser inseridas no arquivo excel
...
arquivo.save("Employees.xlsx")
backup.save(f"backup{data_hora_formatado}.")
